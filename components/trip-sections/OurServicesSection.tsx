      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="mb-3 text-[32px] font-extrabold leading-tight tracking-tight text-black sm:text-4xl md:text-5xl lg:text-[52px]">
            ...
            <em className="font-medium italic text-[#FDB813]">Services</em>
          </h2>
          <div className="mx-auto max-w-lg space-y-1.5 text-[14px] leading-relaxed text-[#6b6a64] sm:text-[15px]">
            <p className="font-semibold text-[#0b0b0b]">
              More than intercity travel.
            </p>
            <p>
              {emphasizePhrases(
                "Traveling Partner is a simple to use platform that combines everyday transportation and business services.",
                ["everyday transportation and business services"],
              )}
            </p>
          </div>
        </motion.div>
