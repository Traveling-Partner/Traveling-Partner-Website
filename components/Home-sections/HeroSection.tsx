        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left order-2 md:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start max-w-xs sm:max-w-sm mx-auto md:mx-0">
              <a href="https://play.google.com/store/apps?hl=en&gl=US" target="_blank" rel="noopener noreferrer" className="block hover:opacity-90 transition-opacity">
              ...
              <a href="https://www.apple.com/app-store/" target="_blank" rel="noopener noreferrer" className="block hover:opacity-90 transition-opacity">
            ...
            <div className="relative w-[260px] h-[260px] sm:w-[320px] sm:h-[320px] md:w-[380px] md:h-[380px] lg:w-[440px] lg:h-[440px] overflow-visible">
              ...
              <div className="absolute -bottom-2 -left-2 sm:-bottom-3 sm:-left-3 bg-white rounded-xl p-2 sm:p-3 shadow-lg border border-gray-100 hidden sm:block z-20">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-[10px] sm:text-xs text-gray-500 leading-none">Trusted by</p>
                    <p className="text-xs sm:text-sm font-bold text-black leading-none">10K+ Riders</p>
                  </div>
                </div>
              </div>
            </div>
