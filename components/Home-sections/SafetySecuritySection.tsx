      ...
      <div className="w-[90%] mx-auto max-w-7xl relative z-10 max-md:w-[96%]">
        <div className="text-center mb-6">
          ...
          <p className="text-center text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed max-md:text-left max-md:text-base">
            Elevating Your Journey with Traveling Partner with Real-Time
            Tracking and Reviews for Recognition, with Exclusive Female Options.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-8">
          <div className="order-2 lg:order-1 space-y-6">
            <div className="flex items-center gap-4 mb-2">
              ...
              <span className="text-[#fdb813] font-bold uppercase tracking-wider text-sm">
                Feature 01
              </span>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 text-lg leading-relaxed max-md:text-base">
              At Traveling Partner, we prioritize your security with our unique
            ...
            <div className="bg-gradient-to-br from-[#fce001]/10 to-[#fdb813]/10 rounded-2xl p-6 border border-[#fce001]/20">
              ...
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
                  <span className="text-[#fdb813] mt-1">•</span>Female drivers
                  can choose rides exclusively with female passengers
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#fdb813] mt-1">•</span>Female
                  passengers can opt for pooling with female partners
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#fdb813] mt-1">•</span>Option to
                  request rides driven by female drivers only
                </li>
              </ul>
            </div>
