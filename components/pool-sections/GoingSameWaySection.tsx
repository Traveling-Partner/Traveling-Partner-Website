  ...
  return (
    <section className="bg-[#FEFBF6] py-2 sm:py-3">
      ...
      <div className="relative overflow-hidden rounded-[24px] bg-[#070604] sm:rounded-[28px]">
        ...
        <div className="relative flex flex-col lg:min-h-[420px] lg:flex-row lg:items-center lg:gap-5 lg:px-10 lg:py-5 xl:px-12">
          {/* ── Content ── */}
          ...
          <div className="relative z-10 mt-1 flex w-full items-center justify-center px-2 pb-5 lg:mt-0 lg:min-h-[200px] lg:flex-1 lg:px-0 lg:pb-0">
