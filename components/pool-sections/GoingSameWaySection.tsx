    ...
    <section className="bg-[#FEFBF6] py-6 sm:py-8">
      ...
      <div className="relative overflow-hidden rounded-[28px] bg-[#070604] sm:rounded-[32px]">
        ...
        <div className="relative flex flex-col lg:flex-row lg:items-center lg:gap-6 lg:px-9 lg:py-5 xl:px-10">
          {/* ── Content ── */}
          <div className="relative z-10 w-full px-5 pb-0 pt-6 sm:px-7 lg:w-[44%] lg:shrink-0 lg:px-0 lg:pb-0 lg:pt-0">
            {/* Badge */}
            ...
            <div className="mb-5 max-w-[420px] space-y-2 text-[15px] leading-[1.55] text-white/85 lg:mb-5 lg:text-base lg:text-[#b7b1a4]">
              ...
              <p>
                {emphasizePhrases(
                  "Built into every journey, it's fair pricing, verified drivers, and real-time tracking from start to finish.",
                  ["verified drivers", "real-time tracking"],
                  "onDark",
                )}
              </p>
              <p className="font-bold text-white">
          ...
          <div className="relative z-10 mt-2 flex w-full items-center justify-center px-2 pb-6 lg:mt-0 lg:min-h-[340px] lg:flex-1 lg:px-0 lg:pb-0">
