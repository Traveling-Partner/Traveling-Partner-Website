...
export default function ContactHero() {
  return (
    <section className="relative w-full overflow-hidden bg-[#FEFBF6]">
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col items-center px-4 pb-14 pt-[110px] text-center sm:px-6 sm:pb-16 sm:pt-[128px] md:pb-20 md:pt-[140px] lg:px-8 lg:pb-24 lg:pt-[150px]">
        {/* Badge */}
