  ...
  return (
    <section className="relative w-full bg-[#FEFBF6] pb-14 pt-4 sm:pb-16">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-8 w-full max-w-[1040px] sm:mb-10 lg:mb-12">
          <div className="relative aspect-[1040/506] w-full overflow-hidden rounded-[22px] bg-[#f7f4ec] sm:rounded-[28px]">
            <Image
              ...
              priority
              sizes="(max-width: 1040px) 92vw, 1040px"
            />
          </div>
        </div>
        ...
        >
          ...
          <article className="min-w-0 order-1 lg:order-none">
            ...
            <div className="mt-8 flex flex-col gap-4 rounded-[20px] border border-[#eceae4] bg-white px-4 py-4 shadow-[0_8px_24px_rgba(0,0,0,0.06)] sm:flex-row sm:items-center sm:justify-between sm:px-6 sm:py-5 lg:hidden">
