...
function FloatChip({
  ...
  return (
    <div
      className={`mbc-float flex items-center gap-2 rounded-full bg-white py-1.5 pl-1.5 pr-3.5 shadow-[0_16px_40px_rgba(0,0,0,0.18)] lg:gap-2.5 lg:py-1.5 lg:pl-1.5 lg:pr-4 ${className}`}
