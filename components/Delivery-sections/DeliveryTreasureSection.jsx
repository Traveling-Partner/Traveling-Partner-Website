...
const treasureContent = [
  {
    ...
    description: "Say goodbye to the complexities of traditional delivery services. Traveling Partner makes sending your items a breeze.",
  },
  {
    title: "Reliable Couriers",
    description: "Our platform connects you with trusted couriers who will handle your treasures with care and professionalism.",
  },
  {
    title: "Cost-Effective",
    description: "Traveling Partner's commission-free approach means you don't have to worry about extra charges eating into your budget.",
  },
  {
    title: "Track Your Package",
    description: "Real-time tracking allows you to monitor your package's journey, providing peace of mind and transparency.",
  },
  {
    title: "Community-Centric",
    description: "We foster a community of support, allowing you to connect with reliable couriers and fellow users.",
  },
];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-white/20 border border-white/30 rounded-full px-4 py-2 mb-6 backdrop-blur-sm">
            ...
            <span className="text-[#1a1a1a] text-sm font-bold uppercase tracking-wider">Delivery Service</span>
          </div>
          <h2 className="text-[#1a1a1a] text-4xl lg:text-5xl xl:text-6xl font-black uppercase tracking-tight mb-3">
            Deliver your <span className="text-white drop-shadow-md">Treasure</span>
          </h2>
