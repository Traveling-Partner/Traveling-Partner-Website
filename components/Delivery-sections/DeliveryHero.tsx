        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
          <div className="w-full md:w-1/2 text-center md:text-left order-2 md:order-1">
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-[28px] font-medium leading-tight text-black mb-2">
              Connecting Senders and Couriers <br />
            ...
            <p className="text-sm sm:text-base text-gray-700 mb-4 md:mb-6 max-w-md mx-auto md:mx-0">
              Sending and receiving items has never been easier with our
              Delivery service. We provide a commission-free platform for users
              to directly connect with delivery services. This feature fosters a
              collaborative environment, encouraging senders and couriers to
              negotiate their own terms without extra fees, ensuring flexibility
              and cost-effective item transfer.
            </p>
          ...
          <div className="w-full md:w-1/2 flex justify-center md:justify-end order-1 md:order-2 mb-6 md:mb-0">
            <div className="relative w-[260px] h-[260px] sm:w-[320px] sm:h-[320px] md:w-[380px] md:h-[380px] lg:w-[440px] lg:h-[440px] overflow-visible">
              ...
              <Image
                src="https://res.cloudinary.com/duubabjk7/image/upload/v1715253509/tp-Imgs/Taxi-stand-img/Delivery-img1_b13eli.png "
