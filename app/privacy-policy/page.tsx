...
export default function PrivacyPolicyPage() {
  const [activeSlug, setActiveSlug] = useState<string>(privacySections[0].slug);
  const pageHeaderRef = useRef<HTMLElement>(null);
  const policyLayoutRef = useRef<HTMLDivElement>(null);
  ...
  const updateSidebar = useCallback(() => {
    const layout = policyLayoutRef.current;
