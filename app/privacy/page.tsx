  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-12">Privacy Policy</h1>

        <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">1. Introduction</h2>
            <p>
              TravelingPartner ("we," "us," "our," or "Company") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-8 space-y-2">
              ...
              <li>Payment Data: Financial information, such as funds associated with a credit or debit account.</li>
              <li>Data From Third Parties: Information we receive from other sources about you.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-8 space-y-2">
              ...
              <li>Generate a personal profile about you to make future visits to the site personalized.</li>
              <li>Increase the efficiency and operation of the site.</li>
              <li>Monitor and analyze trends, usage, and activities for marketing and promotional purposes.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-8 space-y-2">
              ...
              <li>Marketing Communications: With your permission, we may share your information with third parties for marketing purposes.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 p-6 bg-gray-100 rounded-lg">
              <p className="font-semibold">TravelingPartner</p>
              <p>Email: privacy@travelingpartner.com</p>
          ...
          <section>
            ...
            <p className="mb-4">Depending on where you live, you may have certain rights regarding your personal data, including:</p>
            <ul className="list-disc pl-8 space-y-2">
